...
const usernameV = (req: Request, res: Response, next: NextFunction) => {
...
const vocationV = (req: Request, res: Response, next: NextFunction) => {
...
const levelV = (req: Request, res: Response, next: NextFunction) => {
...
const passwordV = (req: Request, res: Response, next: NextFunction) => {
